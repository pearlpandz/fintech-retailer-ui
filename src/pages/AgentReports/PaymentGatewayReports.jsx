        ...
        <div className='mt-6'>
            <div className="mb-6">
                <nav className="text-sm text-gray-500">
                    ...
                    <span className="text-gray-700">Payment Gateway Reports</span>
                </nav>
                <h2 className="text-3xl font-bold text-gray-800 mt-2">Payment Gateway Reports</h2>
            </div>
...
export default PaymentGatewayReports;
