        ...
        <div className='mt-6'>
            <div className="mb-6">
                <nav className="text-sm text-gray-500">
                    ...
                    <span className="text-gray-700">Cashout Reports</span>
                </nav>
                <h2 className="text-3xl font-bold text-gray-800 mt-2">Cashout Reports</h2>
            </div>
