        ...
        <div className='mt-6'>
            <div className="mb-6">
                <nav className="text-sm text-gray-500">
                    ...
                    <span className="text-gray-700">Wallet Transfer History</span>
                </nav>
                <div className="flex justify-between my-4">
                    <h2 className="text-3xl font-bold text-gray-800">Wallet Transfer History</h2>
                    <Link
                        to="/wallet-transfer/find-recipient"
                        className="bg-purple-600 hover:bg-purple-700 text-white font-medium px-4 py-1 rounded"
                    >
                        New Wallet to Wallet
                    </Link>
                </div>
            </div>
